...
from config import BOT_TOKEN, ADMIN_CHAT_ID, ADMIN_API_KEY

DB_PATH = "plinkom.db"

# ---- Admin / Bot konfiqurasiyası ----
# BOT_TOKEN / ADMIN_CHAT_ID / ADMIN_API_KEY artıq config.py-dan gəlir.
# Onları dəyişmək üçün YALNIZ config.py-nı redaktə et.
...
def _startup():
    ...
    # Ayrıca server/servis lazım deyil — pulsuz Web Service kifayət edir.
    if BOT_TOKEN and BOT_TOKEN != "PUT_YOUR_BOT_TOKEN_HERE":
        ...
        print("ℹ️ BOT_TOKEN təyin olunmayıb (config.py) — bot başladılmadı.")
